...
Crossfire documents all Protocol Messages in the [ProtocolMessage.java](common/src/main/java/dev/getelements/elements/crossfire/model/ProtocolMessage.java) type which will always contain the enumeration of all known protocol messages.
...
The handshake messages are used to initiate the matchmaking process. Upon establishing the WebSocket connection, the client must send a `HANDSHAKE` message to the server. The server will only accept a single `HANDSHAKE` message per connection and will respond with either a [HandshakeResponse.java](common/src/main/java/dev/getelements/elements/crossfire/model/handshake/HandshakeResponse.java) or appropriate Protocol Error message.
...
**Sources**: [JoinHandshakeRequest.java](common/src/main/java/dev/getelements/elements/crossfire/model/handshake/JoinHandshakeRequest.java)
...
**Sources**: [FindHandshakeRequest.java](common/src/main/java/dev/getelements/elements/crossfire/model/handshake/FindHandshakeRequest.java)
...
**Sources**: [MatchedResponse.java](common/src/main/java/dev/getelements/elements/crossfire/model/handshake/MatchedResponse.java)
...
**Sources**: [Signal.java](common/src/main/java/dev/getelements/elements/crossfire/model/signal/Signal.java)
...
**Sources**: [BroadcastSignal.java](common/src/main/java/dev/getelements/elements/crossfire/model/signal/BroadcastSignal.java)
...
**Sources**: [DirectSignal.java](common/src/main/java/dev/getelements/elements/crossfire/model/signal/DirectSignal.java)
...
**Sources**: [ConnectBroadcastSignal.java](common/src/main/java/dev/getelements/elements/crossfire/model/signal/ConnectBroadcastSignal.java)
...
**Sources**: [SdpOfferDirectSignal.java](common/src/main/java/dev/getelements/elements/crossfire/model/signal/SdpOfferDirectSignal.java)
...
**Sources**: [SdpAnswerDirectSignal.java](common/src/main/java/dev/getelements/elements/crossfire/model/signal/SdpAnswerDirectSignal.java)
...
**Sources**: [CandidateDirectSignal.java](common/src/main/java/dev/getelements/elements/crossfire/model/signal/CandidateDirectSignal.java)
...
**Sources**: [HostBroadcastSignal.java](common/src/main/java/dev/getelements/elements/crossfire/model/signal/HostBroadcastSignal.java)
